...
model.load_state_dict(torch.load(f'./models/model_{args.id}_norm.pt'))
model.eval()
...
df.to_csv('MLP_DENOISER_TEST_LOSS_LONG_EPOCHS_NORM.csv',mode='a', header=False, index=False)
