...
$conda_env_path/bin/python3 plot_data_gen.py --n_layers $a --hidden_units $b --optimizer $c --conditioning_type $d --activation $e --batch_size $f --lr $g --seed $h  --id $i --eps $j --annealed_step $k --id_script $l > "$output_file" 
